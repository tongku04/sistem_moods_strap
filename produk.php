...
<head>
    ...
    <title>Produk - Moods Strap - Gantungan Aksesoris HP Terbaru</title>
...
<body class="bg-white">
    ...
    <section class="bg-gradient-to-r from-pink-500 to-purple-600 py-16 text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center">
                <h1 class="text-5xl font-bold mb-4">Katalog <span class="text-yellow-300">Produk</span></h1>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="filter-sidebar lg:w-1/4 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-24">
                    ...
                    <div class="mb-6">
                        <div class="relative">
                            <input type="text" id="search-input" placeholder="Cari produk..." class="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent">
                    ...
                    <!-- Rating Filter -->
                    <div class="mb-6">
                        <h4 class="font-bold text-gray-800 mb-4">Rating</h4>
                        <div class="space-y-2">
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="rating" value="5" class="rating-filter rounded-full border-gray-300 text-pink-500 focus:ring-pink-500 mr-3">
                                <span class="text-gray-700 group-hover:text-pink-500 transition flex items-center">
                            ...
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="rating" value="4" class="rating-filter rounded-full border-gray-300 text-pink-500 focus:ring-pink-500 mr-3">
                                <span class="text-gray-700 group-hover:text-pink-500 transition flex items-center">
                                    <div class="flex text-yellow-400 mr-2">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                            ...
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="rating" value="3" class="rating-filter rounded-full border-gray-300 text-pink-500 focus:ring-pink-500 mr-3">
                                <span class="text-gray-700 group-hover:text-pink-500 transition flex items-center">
                                    <div class="flex text-yellow-400 mr-2">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
    ...
    <section class="py-16 bg-gradient-to-r from-pink-50 to-purple-50">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">Berlangganan newsletter kami untuk mendapatkan informasi tentang produk baru dan penawaran eksklusif.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterProducts() {
                ...
                productCount.textContent = `Menampilkan ${visibleCount} dari ${productCards.length} produk`;
            }
